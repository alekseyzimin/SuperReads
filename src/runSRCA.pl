...
print FILE "#!/bin/bash\n\n";
print FILE "#assemble.sh generated by runSRCA.pl\n";
print FILE "set +e\n";
...
print FILE "cd CA\n";
print FILE "tigStore -g genome.gkpStore -t genome.tigStore 2 -d layout -U | tr -d '-' | awk 'BEGIN{print \">unique unitigs\"}{if(\$1 == \"cns\"){seq=\$2}else if(\$1 == \"data.unitig_coverage_stat\" && \$2>=1){print seq\"N\"}}' | jellyfish2 count -L 2 -C -m $ovlMerSize -s \$ESTIMATED_GENOME_SIZE -t $NUM_THREADS -o unitig_mers /dev/fd/0\n";
