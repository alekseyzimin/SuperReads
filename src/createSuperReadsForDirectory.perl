...
$cmd = "zcat ${myProgOutput1_1prefix}_* |$exeDir/myUniq | $exeDir/getRecordsForTandomRepeatKUnitigs | $exeDir/reduceRecordsForKillingKUnitigsToConnectMates.perl -l $merLen $workingDirectory";
&runCommandAndExitIfBad ($cmd, "", 0);
