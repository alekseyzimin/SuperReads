...
fasta_read_parser::fasta_read_parser(int nb_files, char *argv[], unsigned int nb_buffers) :
...
bool fasta_read_parser::thread::next_sequence() {
...
void fasta_read_parser::_read_sequence() {
  seq *new_seq;
  int  nb_reads;
