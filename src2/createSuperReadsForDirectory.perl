...
# $workingDirectory
$cmd = "bash -c \"ufasta sizes -H $kUnitigsFile | tee  work1/kUnitigLengths.txt >(wc -l > work1/numKUnitigs.txt) >(tail -n 1 | awk '{print \\\$1+1}' > work1/maxKUnitigNumber.txt) | awk '{n+=\\\$2}END{print n}' > work1/totBasesInKUnitigs.txt\"";
